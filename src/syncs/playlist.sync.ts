...
// --- Create Playlist ---
export const CreatePlaylistRequest: Sync = (
...
// --- Delete Playlist ---
export const DeletePlaylistRequest: Sync = (
  { request, session, user, playlist },
) => ({
  when: actions([
    Requesting.request,
...
// --- Rename Playlist ---
export const RenamePlaylistRequest: Sync = (
  { request, session, user, playlist, newName },
) => ({
  when: actions([
    Requesting.request,
...
// --- Add Song ---
export const AddSongRequest: Sync = (
  { request, session, user, playlist, song },
) => ({
  when: actions([
    Requesting.request,
...
// --- Remove Song ---
export const RemoveSongRequest: Sync = (
  { request, session, user, playlist, song },
) => ({
  when: actions([
    Requesting.request,
...
// --- Reorder Songs ---
export const ReorderSongsRequest: Sync = (
  { request, session, user, playlist, songs },
) => ({
  when: actions([
    Requesting.request,
